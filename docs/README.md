...
| [`../content/README.md`](../content/README.md) | Content formats for authors (player ships, weapons, enemies, movement paths, stages, tilesets, input profiles, particle presets), one README per folder |
