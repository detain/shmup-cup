...
This is version **0.1.0**, the end of the first milestone, plus the first nine steps of the second
...
and the BOSS HP bar, also on the TV). For the on-device checks there is a
