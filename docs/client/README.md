...
([preview-build.md](preview-build.md#the-gimmick-range-browser-only)). Hits *feel*
...
This is version **0.1.0**, the end of the first milestone, plus the first seven steps of the second
...
for now in the browser's Gimmick Range). For the on-device checks there is a
