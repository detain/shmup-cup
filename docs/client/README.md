...
This is version **0.1.0**, the end of the first milestone, plus the first six steps of the second
...
the MANTA, and the SHIP SELECT box; two players at once). For the on-device checks there is a
