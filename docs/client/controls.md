...
> (`?stage=test-range` in a browser), where the view scrolls by itself and the ship keeps its
> place on screen unless you move it; the other buttons do nothing yet, except
