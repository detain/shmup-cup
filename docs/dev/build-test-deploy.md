...
| `build · benchmark` | `pnpm build` (Tizen budgets included), then `pnpm bench` (M1-19; since M2-18 also every zone under stress and the 30-minute soak) alone on its runner |
