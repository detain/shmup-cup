...
| World | `bg/stars-{far,mid,near}`, `bg/azure-verge` (M1-18), `tiles/terrain-a`; since M2-11 `bg/brine-nebula`, `bg/brine-sea`, `bg/dune-suns`, `bg/dune-ridge`, `tiles/terrain-reef`, `tiles/terrain-dune`; since M2-12 `bg/magma-peaks`, `bg/magma-lava`, `bg/storm-clouds`, `bg/storm-ridge`, `bg/storm-rain`, `tiles/terrain-magma`, `tiles/terrain-ridge`; since M2-13 `bg/vault-membrane`, `bg/vault-folds`, `bg/prism-facets`, `bg/prism-spires`, `tiles/terrain-vault`, `tiles/terrain-prism` | generated |
