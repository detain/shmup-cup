...
| World | `bg/stars-{far,mid,near}`, `bg/azure-verge` (M1-18), `tiles/terrain-a`; since M2-11 `bg/brine-nebula`, `bg/brine-sea`, `bg/dune-suns`, `bg/dune-ridge`, `tiles/terrain-reef`, `tiles/terrain-dune` | generated |
...
([zones-b-and-c.md](zones-b-and-c.md#placeholder-art-scriptsassetsprocedural)).
