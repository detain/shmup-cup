...
>
> Under SwiftShader, where the bench runs, the change reads as **0.65–0.94×** the p95 of the
> single-group scene (0.92–0.94× over the step's three runs, 0.85× on the docs run, 0.65× on the
> review's) — a small gain whose own spread says how little it can be leaned on, and the least
> transferable number here, because software
...
> **Done** (commit `f18c7de`), by scope item 1 alone — see F1 and F9 above, and the plan's own
> as-built notes. Items 2 and 3 were deliberately not needed.
