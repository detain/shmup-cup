...
describe('core/data loadContent — per-kind schemas', () => {
  ...
  it.each([
    ...
    [
      ...
      '',
      'enemies[0].drop',
      'must be one of: capsule, blueCapsule, powerup, oneUp, bonusCapsule',
    ],
    [
      'drop',
      'item:red',
  ...
  it.each([
    [
      ...
      'events[0].type',
      'type must be one of: spawn, formation, warning, boss, music, speed, flag, end, trigger, block, bonus',
    ],
    [
      { x: 0, type: 'branch' },
      'events[0].type',
