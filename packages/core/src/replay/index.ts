 ...
 * Golden-replay tests, the cross-engine determinism check and (later) attract mode all use this
 * one playback path.
 *
 ...
 * {@link REPLAY_FORMAT_VERSION}, {@link REPLAY_HASH_INTERVAL}.
 *
 * @module
 */
import {
...
import { hashWorld, jumpToCheckpoint } from '../debug/index.js';
...
import { createHeadlessPlatform, type Platform, type PlatformInput } from '../platform/index.js';
