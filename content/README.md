...
| [`enemies/`](enemies/README.md) | Enemy definitions: HP, score, hurtbox, behaviour script id and tunables, starting mover, ground anchor, drops; bosses (a `boss` section: WARNING name / code, parts with weak points, phases) | `@shmup/core` `enemies` + `bosses` + `behaviors` + `data` modules |
