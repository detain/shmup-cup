...
| [`rules/`](rules/README.md) | Game-wide rule tables: the difficulty presets Easy / Normal / Hard / Arcade (rank base and growth, lives, extends, continues, death penalty, aim directions, bullet speed) | `@shmup/core` `data` + `config` modules (kind `rules`) |
