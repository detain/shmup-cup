...
apart round the aim — no bullet on the aimed line — at 1.15 px/tick); M2-14 added `abyss.gulp`
(zone I's `gulper`: three aimed 3-ways of round red bullets 28 units apart, 14 ticks apart, at 1
px/tick).
